    ...
    <main className="text-white font-medium">
      ...
      <Link href="#" className="justify-center flex mt-5">
        ...
        >
          ...
          {/* <span className="lg:h-10 lg:w-5 sm:w-5 sm:h-10 bg-primary absolute top-0 sm:right-[-20] lg:right-[-20]"></span>
          <span className="h-7 w-5 bg-primary rotate-45 absolute top-7.25 sm:left-29.5    lg:left-33.5"></span> */}
        </Button>
      </Link>
    </main>
  );
