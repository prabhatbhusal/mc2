...
export const services = [
  {
    ...
    info: "Polk Roadside Experts are reliable when it comes to towing services.  ",
    link: "/services/towing",
  },
  {
    title: "Fuel Delivery",
    url: "/Services/Fueldelivery.jpg",
    info: "Running out of fuel is inconvenient, but Polk Roadside Assistance is here to help. ",
    link: "/services/fuel",
  },
  {
    title: "Lock Out Services",
    url: "/Services/lockout.jpg",
    info: "Polk Roadside Assistance ensures a smooth resolution to such situations.  ",
    link: "/services/lockout",
  },
  {
    title: "Roadside Assistance",
    url: "/Services/roadside.jpg",
    info: "With Polk Roadside Experts, you get comprehensive roadside assistance to tackle any vehicle issue.",
    link: "/services/roadside",
  },
  {
    title: "JumpStart",
    url: "/Services/Jumpstart.jpg",
    info: "No one likes dealing with a dead battery, but with the jump start services of Polk Roadside Assistance, it's a quick fix. ",
    link: "/services/jumpstart",
  },
  {
    title: "Heavy Duty Jump Start",
    url: "/Services/Heavyduty.jpg",
    info: "For those times when a regular jump start isn't enough, Polk Roadside Experts offer Heavy Duty Jump Start services. ",
    link: "/services/heavyduty",
  },
  {
    title: "Tire Repair",
    url: "/Services/tirerepair.jpg",
    info: "When a tire issue arises, Polk Roadside Experts are ready to help. ",
  ...
  },
  {
    ...
    info: "For drivers stranded with a dead battery, Polk Roadside Assistance offers Mobile Battery service. ",
    link: "/services/mobbattery",
  },
  {
    title: "Car Battery Replacement",
    url: "/Services/Batteryreplace.png",
    info: "Polk Roadside Assistance features a responsive Car Battery Replacement service to address battery malfunctions.  ",
    link: "/services/carbattery",
  },
  {
    title: "Air Delivery Service",
    url: "/Services/Towing.jpg",
    info: "Tire issues are no match for Polk Roadside Experts and their Air Delivery Service.  ",
